...
sampling_params = SamplingParams(temperature=0.00, top_p=0.9, max_tokens = 4000, seed=args.seed, stop = '*** END')
...
def response_batch(input_texts: List[str], set_max_tokens = 5000) -> List[str]:
    sampling_params = SamplingParams(temperature=0.00, top_p=0.9, max_tokens = set_max_tokens, seed=args.seed, stop = '*** END')
