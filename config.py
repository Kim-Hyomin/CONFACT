...
def parse_args():
    ...
    parser.add_argument("--method", type=str, choices=["DirectAnswer", "Explain", "CoT", "ConflictLoc", "ConflictLocExact", "ConflictLocClaim", "ConflictLocEvidence", "ConflictLocSoft", "MajorityVoting","AgentBased", "Filter", "RerankSoft", "RerankHard"], default="DirectAnswer", help="processing method")
